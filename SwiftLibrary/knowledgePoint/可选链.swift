...
//    _ = (test as! Person).name //(test as? Person)!  因为返回nil 强制解包 所以崩溃
    ...
    /**
     其实就是class的前8个字节指向metadata区域 这里面有很多东西 可以github  https://github.com/apple/swift/blob/master/docs/ABI/TypeMetadata.rst
     class struct protocol enum 都有不同结构的metadata区域
     metadata能找到这个类型里面有哪些成员属性
...
/**
 可选项本质
 其实就是枚举 -》optional内部就是枚举some  none
 */
